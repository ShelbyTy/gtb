...
try {
    ...
    // getenv() regarde d'abord les variables d'environement, sinon il prend la valeur apres le ?:
    ...
    // PDO c'est mieux que mysqli car ca marche avec plusieur types de bases
    $conn = new PDO(
    ...
    // Si la base ne repond pas on stop la page, pas la peine d'afficher le reste
